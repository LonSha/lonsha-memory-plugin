...
test('v3190 1. 三源同源，且不低于本版', () => {
    ...
    assert.equal(m[1], '3.192.0', 'index.js 版本号为 3.192.0');
    assert.equal(manifest.version, '3.192.0', 'manifest 跟随 index.js');
    assert.equal(pkg.version, '3.192.0', 'package 跟随 index.js');
});
