...
test('【0】版本与注册', () => {
    ...
    assert.ok(vnum(v) >= vnum('3.172.0'), `index.js 版本 ${v} < 3.175.0`);
    assert.ok(vnum(manifest.version) >= vnum('3.172.0'), `manifest ${manifest.version} < 3.175.0`);
    assert.ok(vnum(pkg.version) >= vnum('3.172.0'), `package.json ${pkg.version} < 3.175.0`);
