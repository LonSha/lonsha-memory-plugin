...
test('【0】版本与 manifest', () => {
  ...
  assert.ok(vnum(v) >= vnum('3.196.0'), `index.js 版本 ${v} < 3.196.0`);
  assert.ok(vnum(manifest.version) >= vnum('3.196.0'), `manifest 版本 ${manifest.version} < 3.196.0`);
  ok('版本 / manifest ≥ 3.196.0');
});
