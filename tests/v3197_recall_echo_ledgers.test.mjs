...
test('【0】版本与 manifest 抬升到 3.197.0', () => {
  ...
  assert.ok(vnum(v) >= vnum('3.200.0'), `index.js 版本 ${v} < 3.197.0`);
  assert.ok(vnum(manifest.version) >= vnum('3.200.0'), `manifest 版本 ${manifest.version} < 3.197.0`);
  assert.ok(vnum(pkg.version) >= vnum('3.200.0'), `package 版本 ${pkg.version} < 3.197.0`);
