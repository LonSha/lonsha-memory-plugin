...
test('【4】活跃代码总量下降', () => {
  ...
  //   + 宿主四处接线与两个宿主入口 → 32100。上界只跟活跃模块走，不给死代码留余量。
  assert.ok(total < 32100, `总行数 ${total} < 32100（死代码已清除；上界随活跃功能同步，v3.152/v3.168/v3.170/v3.171/v3.172/v3.174/v3.175/v3.176/v3.180/v3.181/v3.183/v3.184/v3.195/v3.196 放宽）`);
