...
test('【4】活跃代码总量下降', () => {
  ...
  assert.ok(total < 32450, `总行数 ${total} < 32450（死代码已清除；上界随活跃功能同步，v3.152/v3.168/v3.170/v3.171/v3.172/v3.174/v3.175/v3.176/v3.180/v3.181/v3.183/v3.184/v3.195/v3.196/v3.197 放宽）`);
